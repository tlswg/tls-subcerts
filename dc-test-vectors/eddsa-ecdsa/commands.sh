...
rm /out/root.srl
/util/generate_delegated_credential -cert-path /out/ed25519.pem -key-path /out/ed25519key.pem -signature-scheme ECDSAWithP256AndSHA256 -duration 24h -out-path /out/
